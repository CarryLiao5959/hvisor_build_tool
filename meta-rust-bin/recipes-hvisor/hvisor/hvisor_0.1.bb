...
HOMEPAGE = "https://github.com/syswonder/hvisor"
LICENSE = "MIT"
...
SRC_URI = "file:///${HOME}/hvisor_build_tool/hvisor.tar.gz"
...
do_compile_append() {
    ...
    # 调用项目中的 Makefile
    echo "===> do compile path  ${WORKDIR}"
    export PATH=$PATH:/usr/bin/:${WORKDIR}/recipe-sysroot-native/usr/lib/rustlib/x86_64-unknown-linux-gnu/bin/
